        ...
        <div class="glass rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
            ...
            <form action="proses_inputdosen.php" method="post" class="p-6 space-y-5">
                <div>
                    ...
                    <input type="text" name="namaDosen" required placeholder="Masukkan nama dosen..." class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 input-focus-blue transition-all text-sm">
                </div>
                <div>
                    ...
                    <input type="text" name="noHP" required placeholder="Contoh: 08123456789" class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 input-focus-blue transition-all text-sm">
                </div>
                <div class="pt-2">
                    <button type="submit" name="input" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-blue-500/25 btn-press flex items-center justify-center gap-2">
