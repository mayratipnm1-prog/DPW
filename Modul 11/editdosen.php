        ...
        <div class="glass rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
            ...
            <form action="proses_editdosen.php" method="post" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="namaDosen" value="<?php echo htmlspecialchars($namaDosen); ?>" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 input-focus transition-all text-sm">
                </div>
                <div>
