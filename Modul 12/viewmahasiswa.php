...
<body class="theme-mahasiswa text-slate-700 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex gap-1 bg-slate-100/80 p-1 rounded-xl">
                    ...
                    <a href="viewmahasiswa.php" class="px-4 py-2 rounded-lg text-sm font-medium bg-white text-emerald-600 shadow-sm transition-all"><i class="fas fa-user-graduate mr-1.5 text-xs"></i>Mahasiswa</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="inputmahasiswa.php" class="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-5 py-2.5 rounded-xl font-medium shadow-lg shadow-emerald-500/25 transition-all btn-press">
        ...
        <div class="glass rounded-2xl shadow-lg shadow-slate-200/50 border border-white/50 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50/80 to-white/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <form action="viewmahasiswa.php" method="get" class="flex gap-2">
                    <div class="relative">
                    ...
                    <?php if ($keyword): ?>
                    <a href="viewmahasiswa.php" class="px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-sm transition btn-press flex items-center"><i class="fas fa-rotate-left text-xs"></i></a>
                    <?php endif; ?>
                </form>
            </div>
                        ...
                        <tr class="bg-white hover:bg-emerald-50/40 transition-colors group">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2 opacity-80 group-hover:opacity-100 transition-opacity">
                                    <a href="editmahasiswa.php?npm=<?php echo $row['npm']; ?>" class="flex items-center gap-1.5 px-3 py-2 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 rounded-lg text-xs font-semibold transition btn-press"><i class="fas fa-pen text-[10px]"></i>Edit</a>
                                    <button onclick="confirmDelete('hapusmahasiswa.php?npm=<?php echo $row['npm']; ?>', '<?php echo htmlspecialchars(addslashes($row['namaMhs'])); ?>')" class="flex items-center gap-1.5 px-3 py-2 bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 rounded-lg text-xs font-semibold transition btn-press cursor-pointer"><i class="fas fa-trash text-[10px]"></i>Hapus</button>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; else: ?>
