        ...
        <div class="glass rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
            ...
            <form action="proses_editmatakuliah.php" method="post" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="namaMK" value="<?php echo htmlspecialchars($namaMK); ?>" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all text-sm">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="sks" min="1" max="6" value="<?php echo $sks; ?>" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all text-sm">
                    </div>
                    <div>
                        ...
                        <input type="number" name="jam" min="1" max="10" value="<?php echo $jam; ?>" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all text-sm">
                    </div>
                </div>
