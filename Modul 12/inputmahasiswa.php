            ...
            <form action="proses_inputmahasiswa.php" method="post" class="p-6 space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="npm" required placeholder="Contoh: 253307003" class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-sm">
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="text" name="namaMhs" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-sm">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="prodi" required placeholder="Contoh: D3 Teknologi Informasi" class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-sm">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="noHP" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-sm">
                    </div>
                    <div class="col-span-2">
                        ...
                        <textarea name="alamat" required rows="3" class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all text-sm resize-none"></textarea>
                    </div>
                </div>
                <div class="pt-2 flex gap-3">
                    ...
                    <button type="submit" name="tambah" class="flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-emerald-500/25 btn-press flex items-center justify-center gap-2">
