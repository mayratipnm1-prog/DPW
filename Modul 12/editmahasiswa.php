            ...
            <form action="proses_editmahasiswa.php" method="post" class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="namaMhs" value="<?php echo htmlspecialchars($namaMhs); ?>" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all text-sm">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="prodi" value="<?php echo htmlspecialchars($prodi); ?>" required class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all text-sm">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="alamat" required rows="3" class="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 transition-all text-sm resize-none"><?php echo htmlspecialchars($alamat); ?></textarea>
                    </div>
                </div>
